 ...
 * @author LENOVO
 */
public class NhatKyChiGUI extends javax.swing.JFrame {

    private NhatKyChiBUS nkBUS = new NhatKyChiBUS();
    private NhatKyChiDAO nkDAO = new NhatKyChiDAO();

    /**
     * Creates new form NhatKyChiGUI
     */
    public NhatKyChiGUI() {
        initComponents();
        nkBUS.list();
    ...
    private void initComponents() {
        ...
        tfMucchi = new javax.swing.JTextField();
        ...
        jLabel1.setText("NHAT KY CHI TIEU");

        jLabel2.setText("ID");

        jLabel3.setText("Ngay");

        jLabel4.setText("Mucchi");

        jLabel5.setText("Sotien");

        jLabel6.setText("Ghichu");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(tfSotien, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(tfMucchi, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(21, 21, 21)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        String mucchi = tfMucchi.getText();
        String ghichu = taGhichu.getText();
        double sotien = Double.parseDouble(tfSotien.getText());
        NhatKyChiDTO nkDTO = new NhatKyChiDTO(ID, ngay, mucchi, ghichu, sotien);
        nkBUS.add(nkDTO);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhatKyChiGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NhatKyChiGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField tfMucchi;
